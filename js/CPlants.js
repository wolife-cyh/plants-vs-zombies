var CPlants = NewO({
    ...
    ChangeR: function (f, a) {
        var d = f.R, c = [], k = d - 1, h, g = a.id, i = -1, b = $(g), j = b.childNodes[1], e = oGd.$LF;
