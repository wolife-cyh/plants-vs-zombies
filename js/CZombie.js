var CZombies = function (b, a) {
    return (a = function () {
        ...
        prepareBirth: function (f) {
            var h = this, e = h.ArR, d = e[Math.floor(Math.random() * e.length)], g = GetY(d) + h.GetDY,
                c = g - h.height, k = 3 * d + 1, j = h.id = "Z_" + Math.random();
            h.R = d;
            h.pixelTop = c;
            h.zIndex = k;
    ...
    Ornaments: 1, OrnLostNormalGif: 7, OrnLostAttackGif: 8, getHurt: function (j, a, g, n, c, l, k) {
        var e = this;
        if (!e.beAttacked) {
            k && e.Die(2);
            return
