var $User = function () {
        var a = navigator.platform, e = navigator.userAgent, c = (a == "Win32" || a == "Windows"),
            d = (a == "Mac68K" || a == "MacPPC" || a == "Macintosh"), b = (a == "X11" && !c && !d), f = c || d || b;
        return {
            Browser: {
    ...
    innerText = (function () {
        ...
        LoadProgress: function (r, l, a) {
            ...
            var p = oS, j = [], i = p.PicArr, k = p.PName, s = p.ZName, u = 0,
                d = document.createTextNode("正在准备载入游戏素材。。。"), t = GetX(11), g = oGd.$LF, b = oGd.$ZF,
                c = oS.R + 1, e = p.LoadImage, h = p.CheckImg, f = p.InitPn, m, q;
        ...
        Init: function (b) {
            ...
            var c, a, e = this.$, i, k = Refresh = 0, j = 1000, h, g, b = function (l) {
            ...
            (function (n) {
                var m = (i = e[n]).length, l = arguments.callee;
                while (m--) {
                    c = i[m];
        ...
        i = window.event || i;
        var a = i.clientX, k = i.clientY + document.body.scrollTop, g = ChosePlantX(a), h = ChosePlantY(k), d = g[0],
            c = h[0], f = h[1], b = g[1], j = GetAP(a, k, f, b);
        switch (oS.Chose) {
            case 1:
        ...
        k = window.event || k;
        var d = k.clientX, b = k.clientY + document.body.scrollTop, m = oS.ChoseCard, h = ChosePlantX(d),
            i = ChosePlantY(b), f = h[0], c = i[0], g = i[1], a = h[1], p = GetAP(d, b, g, a);
        switch (oS.Chose) {
            case 1:
        ...
        var c = oS.PName, b = -1, a = c.length;
        while (++b < a) {
            SelectCard(c[b].prototype.EName)
        }
    }, InitPCard = function () {
        var d = "", f, e = oS.PName, a = e.length, b = 0, c;
        while (b < a) {
            f = e[b];
            c = f.prototype;
        ...
        var a = $("Card" + f).firstChild, i = ArPCard[f], c = i.PName.prototype, h, e, b, g = $("btnOK");
        if (!i.Select) {
            if (!(ArPCard.SelNum |= 0)) {
                g.disabled = "";
                g.style.color = "#FC6"
        ...
        var b = $("dZombie"), f = $("dCardList"), h = 0, l = f.childNodes.length, g, j, m, e, k, a, c = $("dBody");
        ...
        var f = $("dTitle"), e = ArCard[b], c = e.PName.prototype,
        ...
        var g = oS.ChoseCard, e = ArCard[g], f = e.PName, h = f.prototype;
        ...
        var e = "LawnMower" + b, c = $(e), d = oS.LawnMowerX, a = oS.W;
        oGd.$LM[b] = 0;
        (function () {
            var g = oZ.getArZ(d, d + 50, b), f = g.length;
            while (f--) {
                g[f].Die(2)
            }
...
CheckAutoSun = function (a) {
    ...
    document.cookie = a + "=0;"
}, WordUTF8 = '<div id="dLogo" style="position:absolute;width:900px;height:600px;background:#000 url(images/Logo.jpg) no-repeat;z-index:1"><span style="position:absolute;line-height:1.5;left:349px;top:10px;width:524px;text-align:right;font-size:15pt; font-family:&#x9ED1;&#x4F53;;color:#F60; top:32px"><span style="font-family:Verdana"></span><span style="font-family:Verdana"></span><br> <span style="font-family:Verdana"></span><br><b></b></span><div id="LogoWord" style="position:absolute;color:#FF0;top:510px;width:100%;height:90px"><span style="position:absolute;font-size:15pt;width:321px;height:69px; font-family:&#x9ED1;&#x4F53;;line-height:69px; left:60px; top:10px;cursor:pointer;background:url(images/interface/LogoLine.png) no-repeat center -5px;text-align:center" onclick="SetBlock($(\'dSurface\'),$(\'iSurfaceBackground\'))"><span style="font-size:15pt; font-family:Verdana;color:#FF0;cursor:pointer;">JavaScript</span></span><span style="position:absolute;font-size:11pt;left:407px;top:29px;line-height:1.5;font-weight:bold"><span style="cursor:pointer;" onclick="SetBlock($(\'dProcess\'))"><span id="sTime"></span></span><br><a target="_blank" style="cursor:pointer;color:#FF0;" href="http://www.ylcom.net">)</a></span></div></div>', SelectModal = function (g) {
